...
class Chips():
	...
	def __init__(self, total=100):
		self.total = total # this can be set to default value or supplied by user input
		self.bet = 0
...
while True:
	...
	print("WELCOME TO BLACKJACK") # Welcome statement
	...
	# If player has not busted, play Dealers hand until dealer reaches 17
	if player_hand.value <= 21:
